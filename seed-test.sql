...
DECLARE
  ...
  w_id UUID := 'a8b89e62-c07a-4c07-b248-cb3502570b55'; -- Workspace ID

  p_social_id UUID := '0f092789-983f-4228-a3cf-cfb577312108'; -- Social Media Project (Tarefa Comum)
  p_branding_id UUID := 'f0238e88-cfb2-4d1e-ae7a-05c2826a7989'; -- Branding Project (Grade Editorial)
...
BEGIN
  ...
  -- 1. Seed Profiles (assuming Auth Users already exist in local db)
  ...
  -- 5. Seed Projects
  -- Social Media Project (Should resolve to Common Task Layout)
  ...
  -- Branding Project (Should resolve to Editorial Grid Task Layout)
  INSERT INTO public.v2_projects (id, workspace_id, client_id, name, workflow_type, status, priority, owner_id, type, amount, billing_day, start_date)
  ...
  -- 7. Seed Tasks
  -- Social Media Task (Tarefa Comum, no posts)
  ...
  -- Branding Task (Grade Editorial, includes posts)
  INSERT INTO public.v2_tasks (id, project_id, stage_id, title, description, type, task_type, status, priority, "order", stage_order, html_content)
  ...
  -- Revenue for Social Media Project (paid)
  ...
  -- Revenues for Branding Project (Pending & Overdue)
  INSERT INTO public.revenues (id, project_id, amount, due_date, status, type)
  VALUES 
